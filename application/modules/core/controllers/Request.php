...
class Request extends MX_Controller
{
   ...
   public function ajax()
   {
      ...
      if($oinput->post('mod') || $oinput->get('mod')){
		 ...
		 $sessionExceptions = array('get_urls','loginuser','forgotpassword','change_password_form','emtrs_change_password','fetch_employee_name','emtrs_login','emtrs_logout','emtrs_timein','emtrs_timeout');
		 
		 if(!in_array($smodule_method,$sessionExceptions)){
         //enable to validate session
			 /*if(!$this->session->userdata('user_id')){
				header('Content-Type: application/json');
				$result = $this->common->apiData("error","session_expired","Session is Expired!");
