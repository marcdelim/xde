...
class Minify
{
	...
	private function _output($files, $type)
	{
		...
		foreach ($files as $file)
		{
			...
			$output[] = $this->html_tags ? sprintf($template, $file) : $file;
		}
	...
	{
		require_once(APPPATH . 'modules/core/libraries/minify/JSMin.php');
	...
	{
		require_once(APPPATH . 'modules/core/libraries/minify/JSMinPlus.php');
	...
	{
		require_once(APPPATH . 'modules/core/libraries/minify/cssmin-v3.0.1.php');
	...
	{
		require_once(APPPATH . 'modules/core/libraries/minify/cssminify.php');
