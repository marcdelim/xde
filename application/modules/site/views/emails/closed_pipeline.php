                    ...
                    <tr>
                        <td class="content-wrap">
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">  
										Sale Status of pipeline ID number: <?=$pipelineID?> has been updated from {current sales status} to Closed - Uploaded / Published. Kindly created Advertising Order in SAP - ERP.
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
										Please access the link to view transactions details.
