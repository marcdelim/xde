                    ...
                    <tr>
                        <td class="content-wrap">
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">  
										Campaign <?=$name?> has an update<br>
<!-- 										Description: <?=$description != '' ? $description : 'N/A'?> <br> 
										Brand: <?=$brand?> <br>
										Product Variant: <?=$variant?> <br>
										Company: <?=$company?> <br>
...
<!--                                     <td class="content-block aligncenter">
                                    	Please click the link to see details.
                                        <a href="<?php echo site_url('/campaign/'); ?>" class="btn-primary">Confirm Email Address</a>
                                    </td> -->
                                </tr>
						  </table>
                        </td>
