                    ...
                    <tr>
                        <td class="content-wrap">
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">  
										Please see below request for your approval: <br><br>

										<b>Brand:</b> <?=$brand_val?> <br>
										<b>Product Variant:</b> <?=$variant_val?> <br>
										<b>Company:</b> <?=$company_val?> <br>
										<b>Industry:</b> <?=$industy_val?> <br>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block aligncenter">
                                        <a href="<?php echo site_url('/maintenance/product/'); ?>" class="btn-primary">Brand details</a>
                                    </td>
                                </tr>
						  </table>
                        </td>
