                    ...
                    <tr>
                        <td class="content-wrap">
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">  
										Production Status of Pipeline ID: <?=$pipelineID?> has been updated to Published/Uploaded. Kindly update the sales status to Closed - Uploaded/Published.
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
										Please access the link to view transaction details. <br>
										<a href="<?= site_url('/manage/'.$pipelineID); ?>"><h4><?=$pipelineID?></h4></a>
                                    </td>
                                </tr>
<!--                                 <tr>
